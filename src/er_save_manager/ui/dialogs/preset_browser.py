...
class EnhancedPresetBrowser:
    ...
    def show(self):
        ...
        self.browse_tab = self.tabview.add(N_("Browse Presets"))
        self.contribute_tab = self.tabview.add(N_("Contribute Preset"))
    ...
    def setup_browse_tab(self):
        ...
        self.sort_var = TranslatedVar(
            value="Recent",
            choices=[N_("Recent"), N_("Likes"), N_("Downloads"), N_("Name")],
        )
